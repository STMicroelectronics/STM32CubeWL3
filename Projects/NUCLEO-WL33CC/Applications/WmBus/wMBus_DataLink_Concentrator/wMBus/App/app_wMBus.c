...
/* Private variables ---------------------------------------------------------*/
wMBus_Phy_submode_t wMBus_mode = C_MODE;
wMBus_Phy_frame_format_t wMBus_format = WMBUS_FORMAT_A;
wMBus_Phy_direction_t wMBus_direction = METER_TO_OTHER;
wMBus_Phy_meter_modes_t wMBus_device_type = OTHER;
wMBus_DataLink_status_t status;
#ifdef PROCESS_FRAME
wMBus_DataLink_frame_t receivedFrame;
#else
uint8_t *rxBuff;
uint16_t rxBuffLength;
#endif
