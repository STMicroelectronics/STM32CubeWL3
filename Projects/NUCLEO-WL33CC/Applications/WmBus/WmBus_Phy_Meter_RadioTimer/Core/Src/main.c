...
static void MX_MRSUBG_TIMER_Init(void)
{
  /* USER CODE BEGIN MX_MRSUBG_TIMER_Init 0 */

  /* USER CODE END MX_MRSUBG_TIMER_Init 0 */

  MRSUBG_TIMER_InitTypeDef MRSUBG_TIMER_InitStruct = {0};

  /* USER CODE BEGIN MX_MRSUBG_TIMER_Init 1 */

  /* USER CODE END MX_MRSUBG_TIMER_Init 1 */
  ...
  MRSUBG_TIMER_InitStruct.XTAL_StartupTime = 1500;  // 1.5 ms
...
#endif
/* USER CODE BEGIN MX_MRSUBG_TIMER_Init 2 */

/* USER CODE END MX_MRSUBG_TIMER_Init 2 */
}
