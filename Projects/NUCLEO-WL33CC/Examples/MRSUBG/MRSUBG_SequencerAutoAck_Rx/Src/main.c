...
static MRSubG_Sequencer_GlobalConfiguration globalcfg;
static MRSubG_Sequencer_ActionConfiguration actioncfgWaitMsg;
static MRSubG_Sequencer_ActionConfiguration actioncfgSendACK;
