...
/**
  ...
  * @brief   This file provides code for MSP initialization
...
/**
  ...
  * @note   This function is called from HAL_Init() to perform system
...
/**
  * @brief  Initializes MRSubG MSP.
  * @note   This function configures the hardware resources used in this example.
  * @retval None
  */
...
/**
  * @brief  De-initializes MRSubG MSP.
  * @note   This function releases the hardware resources used in this example.
  * @retval None
  */
