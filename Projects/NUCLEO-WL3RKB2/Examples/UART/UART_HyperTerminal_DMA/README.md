...
between a board and an HyperTerminal PC application.
    ...
    Board: NUCLEO-WL3RKB2 (embeds a STM32WL3RKBVx device)
       ...
       - Rx Pin: PB.14(connected to pin 35 of connector CN3 :available through VCP)
...
NUCLEO-WL3RKB2 board LEDs are used to monitor the transfer status:
...
### <b>Directory contents</b>
  ...
  - UART/UART_HyperTerminal_DMA/Inc/stm32wl3r_nucleo_conf.h BSP configuration file
