...
Enabling/disabling of the low-speed external(LSE) RC oscillator (about 32 KHz) at run time, using the RCC HAL API.
   ...
   - Microcontroller Clock Output LCO Pin: PB.12  (Morpho connector CN3 pin 27)
...
LSE clock waveform is available on the LCO pin PB.12 (make sure to close the SB8) and can be captured
on an oscilloscope.
...
### <b>Directory contents</b>
  ...
  - RCC/RCC_LSEConfig/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
