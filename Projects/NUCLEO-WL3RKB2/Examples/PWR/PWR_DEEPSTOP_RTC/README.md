...
In the associated software, the system clock is set to 0 and the SysTick is
...
### <b>Directory contents</b>
  ...
  - PWR/PWR_DEEPSTOP_RTC/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WL3RKB2 Set-up
    - Use LD1 and LD3 connected respectively to PB.07 and $LD3_PIN$ pins
