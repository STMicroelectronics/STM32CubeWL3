...
The timer output channel must be connected to TIM2_CH4 on board NUCLEO-WL3RKB1.
Thus TIM2_CH4 status (on/off) mirrors the timer output level (active v.s. inactive).
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WL3RKB2 Set-up:
      - TIM2_CH4  PA9: connected to (Arduino connector CN6 pin 3 D10, Morpho connector CN4 pin 17)  
