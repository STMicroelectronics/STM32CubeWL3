...
Data buffer transmission/reception between two boards via SPI using DMA.
	...
	Board: NUCLEO-WL3RKB1 (embeds a STM32WL3RKBCVx device)
    CLK Pin: PB6 (CN4, pin 3)
    MISO Pin: PA8 (CN4, pin 13)
    MOSI Pin: PA11 (CN4, pin 15)
...
### <b>Directory contents</b> 
  ...
  - SPI/SPI_FullDuplex_ComDMA_Master/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
...
### <b>Hardware and Software environment</b> 
  ...
  - This example has been tested with STMicroelectronics NUCLEO-WL3RKB1 board and can be
    easily tailored to any other supported device and development board.

  - NUCLEO-WL3RKB1 Set-up
    - Connect Master board PB6 (CN4, pin 3) to Slave Board PB6 (CN4, pin 3)
    - Connect Master board PA8 (CN4, pin 13) to Slave Board PA8 (CN4, pin 13)
    - Connect Master board PA11 (CN4, pin 15) to Slave Board PA11 (CN4, pin 15)
