...
Configuration of the system clock (SYSCLK) and modification of the clock settings in Run mode, using the RCC HAL API.
   ...
   - Microcontroller Clock Output MCO Pin: PA.11 (Arduino connector CN6 pin 4 D11, Morpho connector CN4 pin 15)
...
### <b>Directory contents</b>
  ...
  - RCC/RCC_ClockConfig/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
