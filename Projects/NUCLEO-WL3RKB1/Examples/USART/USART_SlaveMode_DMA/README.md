...
- While slave board is waiting for the reception of the buffer, its
  LD1 is blinking rapidly (100 ms period).
- When the transmission/reception processes starts, LD1 is turned off.
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-WL33CC set-up
    - Connect Master board PB.06 (SCK)(3 CN4) to Slave Board PB1(USART CK)(28 CN3)
    - Connect Master board PA.08 (MISO)(13 CN4) to Slave Board PA9 (USART TX)(17 CN4)
    - Connect Master board PA.11 (MOSI)(15 CN4) to Slave Board PB0 (USART RX)(34 CN4)
    	* Ensure that SB06 is off on the Slave Board.
