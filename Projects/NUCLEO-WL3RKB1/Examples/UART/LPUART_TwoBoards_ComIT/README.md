...
Board: NUCLEO-WL3RKB1 (embeds a STM32WL3RKBVx device)
Tx Pin: PB.06 (pin 3 on CN4)
Rx Pin: PB.07 (pin 7 on CN4)
...
### <b>Directory contents</b>
  ...
  - UART/LPUART_TwoBoards_ComIT/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with NUCLEO-WL3RKB1 board and can be
    easily tailored to any other supported device and development board.

  - STM32WL3RKBVx Set-up
    - Connect a wire between 1st board PB.06 (pin 3 on CN4) pin (LPUART Tx) and 2nd board PB.07 (pin 6 on CN4) pin (LPUART Rx).
    - Connect a wire between 1st board PB.07 (pin 6 on CN4) pin (LPUART Rx) and 2nd board PB.06 (pin 3 on CN4) pin (LPUART Tx).
