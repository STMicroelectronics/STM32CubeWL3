...
NUCLEO-WL3RKB board's LED can be used to monitor the transfer status:
...
### <b>Directory contents</b>
  ...
  - FLASH/FLASH_WriteProtection/Inc/stm32wl3r_nucleo_conf.h     BSP configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-WL3RKB board and can be
